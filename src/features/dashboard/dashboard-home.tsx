  ...
  return (
    <div className="space-y-8">
      <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        <div className="overflow-hidden rounded-[32px] border border-white/10 bg-[linear-gradient(145deg,rgba(12,19,34,0.96),rgba(6,10,20,0.9))] p-6 shadow-[0_20px_90px_rgba(0,0,0,0.42)] sm:p-8">
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <div className="space-y-5">
              ...
              {activeModule ? (
                <div className="grid gap-4 rounded-[28px] border border-white/10 bg-white/[0.04] p-5 sm:grid-cols-[1fr_auto] sm:items-end">
                  <div>
                    ...
                    <p className="mt-2 max-w-xl text-sm leading-6 text-slate-300">{activeModule.summary}</p>
                    <div className="mt-4 grid gap-3 sm:grid-cols-2">
                      {activeModule.focusAreas.map((area) => (
                        <div key={area} className="rounded-2xl border border-white/8 bg-slate-900/70 px-4 py-3 text-sm text-slate-200">
                          {area}
                        </div>
                      ))}
                    </div>
        ...
        <div className="space-y-6">
          <div className="overflow-hidden rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,rgba(8,12,22,0.98),rgba(14,24,44,0.85))] p-5">
            <div className="flex items-center justify-between">
              <div>
...
function LinkCard({
  ...
  return (
    <Link
      href={href}
      className="rounded-[28px] border border-white/10 bg-white/[0.04] p-5 transition hover:-translate-y-0.5 hover:bg-white/[0.06]"
    >
...
function SequenceCard({
  ...
  return (
    <Link href={href} className="rounded-[28px] border border-white/8 bg-white/[0.04] p-5 transition hover:border-cyan-300/25 hover:bg-white/[0.06]">
