        ...
        <aside className="glass-panel flex w-full min-w-0 flex-col gap-6 rounded-[32px] p-5 lg:sticky lg:top-4 lg:h-[calc(100vh-2rem)] lg:w-[320px] lg:min-w-[320px] lg:overflow-y-auto">
          <div className="flex items-center gap-4 border-b border-white/8 pb-5">
            ...
            <div>
              ...
              <h1 className="text-lg font-semibold text-white">Trading learning system</h1>
            </div>
          </div>
          ...
          <div className="course-card rounded-[28px] p-4">
            <div className="flex items-end justify-between gap-4">
              <div>
                <p className="eyebrow-label">Current Rank</p>
          ...
          <div className="course-card rounded-[28px] p-4">
            <div className="flex items-center gap-2">
              ...
              <p className="eyebrow-label">Training Loop</p>
            </div>
          ...
          <div className="mt-auto rounded-[28px] border border-cyan-400/15 bg-[linear-gradient(180deg,rgba(16,185,129,0.12),rgba(14,165,233,0.08))] p-4">
            <p className="eyebrow-label text-cyan-100/70">Why It Matters</p>
